		...
		return(
			<Form horizontal style={{marginTop: 30}} >
			        ...
			        <FormItem  {...formItemLayout}  label="事件类型：">
	    	        	<Select {...typeProps} size="large" value={safeString(this.state.event_type)} onChange={::this.onChangeEventType} placeholder="请选择类型：" >
	    	        		{
		        	...
		        	<div hidden={this.state.event_type != 4}>
		        		<FormItem  {...formItemLayout} label="场景回复：">
		    	        	<Select {...sceneProps} size="large"  placeholder="请选择类型：" >
		    	        		{
		        	...
		        	<FormItem
			          ...
			          hasFeedback
			          >
			            <RadioGroup {...signProps} value={safeString(this.state.sign_type)} onChange={::this.onChangeSignType}>
		                  	{
		        	...
		        	<FormItem  {...formItemLayout} label="回复类型：">
	    	        	<Select {...replyTypeProps} size="large" value={safeString(this.state.reply_type)} onChange={::this.onChangeReplyType} placeholder="请选择类型：">
	    	        		{
		        	...
		        	<div hidden={this.state.reply_type == 1?false:true}>
			 		...
			 		<div hidden={this.state.reply_type == 2?false:true}>
			        	<FormItem  {...formItemLayout} label="选择图片素材：">
		    	        	...
		    	        	size="large" 
		    	        	value={safeString(this.state.content)} 
			         ...
			         <FormItem {...formItemLayout} style={{marginTop: 20}}>
		         		...
		         		>
				        	<Col offset={offset(this.state.reply_type)}>
		        	        	<Button style={{width: 120}} type="primary" onClick={::this.handleEdit}  size="large">提交</Button>
		        			</Col>
		        		</Auth>
				     </FormItem>
				</Form>
