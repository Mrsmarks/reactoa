...
export default class UserAnsComp extends React.Component {
	...
	handleSearch(e) {
    	...
    	this.props.form.validateFields((errors, values) => {
	      	...
	      	const start_time = format(values.start_time.getTime())
	      	const end_time = format(values.end_time.getTime())
	...
	exportData(e) {
    	...
    	this.props.form.validateFields((errors, values) => {
	      	...
	      	const start_time = start_time? format(values.start_time.getTime()): ''
	      	const end_time = end_time? format(values.end_time.getTime()): ''
