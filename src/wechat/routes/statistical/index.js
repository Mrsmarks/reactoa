...
export default [{
    path: '/wechat/statistical/user/list(/:page)(/:psize)',
    name: '用户分析',
    component: user_analysis,
}, {
    path: '/wechat/statistical/picture/list(/:page)(/:psize)',
    name: '图文分析',
    ...
    path: '/wechat/statistical/message/list(/:page)(/:psize)',
    name: '消息分析',
    ...
    path: '/wechat/statistical/interface/list(/:page)(/:psize)',
    name: '接口分析',
