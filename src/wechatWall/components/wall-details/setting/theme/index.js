...
export default class GroupComp extends  React.Component {
	...
	handlePageChange(nextPage, pageSize) {
		...
		this.context.router.push({
			pathname: '/wall/activity-theme/index',
			query: query
		})
		this.props.actions.settingThemeList(query)
	}

	handleAdd(sid, info) {
		this.props.actions.addThemeList(sid, info).then(resolve => {
	...
	handleUpdate(info, id) {
		this.props.actions.updateThemeList(info, id).then(resolve => {
			message.success(resolve.errormsg)
	...
	handleRemove(id) {
		this.props.actions.delThemeList(id).then(resolve => {
			message.success(resolve.errormsg)
		})
	}
