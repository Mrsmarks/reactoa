...
export default class MainModal extends React.Component{
	...
	handleSubmit() {
		this.props.form.validateFields((err, values) => {
			...
			formData.start_time = this.state.start_time
			formData.end_time =this.state.end_time
			formData.draw_start_time = this.state.draw_start_time
			formData.draw_end_time = this.state.draw_end_time
			formData.aid = this.context.location.query.aid
			const aid = this.context.location.query.aid
			this.props.actions.addSettingList(formData, aid).then(resolve => {
		...
		return(
			<Form horizontal >
		        <FormItem
		          ...
		          hasFeedback
		          >
		         <RangePicker showTime format="yyyy/MM/dd HH:mm:ss" onChange={::this.activeTimeChange} />
		        </FormItem>
		         ...
		         <FormItem
		          ...
		          hasFeedback
		          >
		         <RangePicker showTime format="yyyy/MM/dd HH:mm:ss" onChange={::this.drawTimeChange} />
		        </FormItem>
	...
	renderTable() {
		...
		const columns = [{
			...
			render(_, obj) {
				return (
					<div>
						<a onClick={toggleModal(obj, 'visible')}>编辑</a>
