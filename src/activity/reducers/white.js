...
import { 
	FETCH_ACTIVITY_WHITE_LIST,
	ADD_ACTIVITY_WHITE_LIST,
	DELETE_ACTIVITY_WHITE_LIST,
	UPDATE_ACTIVITY_WHITE_LIST
...
const actionHandlers = {
	[FETCH_ACTIVITY_WHITE_LIST]: (state, { response, params, select }) => {
